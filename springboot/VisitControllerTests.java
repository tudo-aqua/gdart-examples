...
class VisitControllerTests {
	...
	/*
	 * @BeforeEach void init() { int i = Verifier.nondetInt(); if (i == TEST_PET_ID) {
	 * given(this.pets.findById(TEST_PET_ID)).willReturn(new Pet()); } else {
	 * given(this.pets.findById(TEST_PET_ID)).willReturn(null); } }
	 */
